// ✅ src/components/common/SocialIcons.tsx — Production Ready with SVG for LINE & Messenger & Website
...
const socials = [
  {
    ...
    label: "Messenger",
    svg: (
      <svg viewBox="0 0 32 32" fill="currentColor" className="w-5 h-5" aria-hidden="true" focusable="false">
